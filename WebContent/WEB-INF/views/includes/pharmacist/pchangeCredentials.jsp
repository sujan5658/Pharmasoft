...
<form:form action="pcredentialsChange" method="post">
	...
	<div class="form-group">
		<label>New Password</label> <input type="password"
			...
			placeholder="New User Password" id="pass1" required="required" />
	</div>
	<div class="form-group">
		<label>Confirm Password</label> <input type="password"
			class="form-control" style="width: 250px"
			placeholder="Retype Password" id="pass2" oninput="checkPassword();" required="required" />
	</div>
